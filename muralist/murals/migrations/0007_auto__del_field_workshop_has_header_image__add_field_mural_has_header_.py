...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Workshop.has_header_image'
        db.delete_column('murals_workshop', 'has_header_image')

        # Adding field 'Mural.has_header_image'
        db.add_column('murals_mural', 'has_header_image', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Workshop.has_header_image'
        db.add_column('murals_workshop', 'has_header_image', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Mural.has_header_image'
        db.delete_column('murals_mural', 'has_header_image')
    ...
    models = {
        ...
        'murals.mural': {
            ...
            'has_header_image': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'lost': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),

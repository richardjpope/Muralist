...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mural.height'
        db.alter_column('murals_mural', 'height', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'Mural.width'
        db.alter_column('murals_mural', 'width', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Mural.height'
        db.alter_column('murals_mural', 'height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'Mural.width'
        db.alter_column('murals_mural', 'width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Artist.lost'
        db.delete_column('murals_artist', 'lost')

        # Adding field 'Mural.lost'
        db.add_column('murals_mural', 'lost', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Artist.lost'
        db.add_column('murals_artist', 'lost', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Mural.lost'
        db.delete_column('murals_mural', 'lost')
